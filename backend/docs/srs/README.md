...
| [`SRS_Task092_uc9-retail-voucher-preview.md`](SRS_Task092_uc9-retail-voucher-preview.md) | **Task092** — UC9 POS: API xem trước / kiểm tra voucher (`POST …/retail/voucher-preview` baseline), không tạo đơn; **Draft**; GAP: `API_Task092` + `API_PROJECT_DESIGN.md` |
