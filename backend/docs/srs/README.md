...
| [`SRS_Task069-072_debts-api.md`](SRS_Task069-072_debts-api.md) | **Gộp Task069–072** — `GET|POST|GET|PATCH /api/v1/debts`; bảng `partnerdebts` + join KH/NCC; **Draft** 30/04/2026; **OQ** PO: quyền ghi (thiếu `created_by` V1), Cleared + `paymentAmount`; API: [`../../../frontend/docs/api/API_Task069_debts_get_list.md`](../../../frontend/docs/api/API_Task069_debts_get_list.md) … `API_Task072` |
