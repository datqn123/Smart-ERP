...
| [`SRS_Task034-041_products-management.md`](SRS_Task034-041_products-management.md) | **Gộp** Task034–041 (không có Task040 trong repo) — sản phẩm: list, CRUD, ảnh URL, xóa/bulk-delete; **Approved** (đồng bộ OQ PO 27/04/2026); API: `API_Task034` … `API_Task039`, `API_Task041` trong [`../../../frontend/docs/api/`](../../../frontend/docs/api/) |
