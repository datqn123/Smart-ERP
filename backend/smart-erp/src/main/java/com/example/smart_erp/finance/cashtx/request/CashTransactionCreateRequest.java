...
public record CashTransactionCreateRequest(@NotBlank String direction, @NotNull @Positive BigDecimal amount,
		@NotBlank @Size(min = 1, max = 100) String category, @Size(max = 2000) String description,
		@Size(max = 30) String paymentMethod, @NotNull LocalDate transactionDate, String status) {
}
