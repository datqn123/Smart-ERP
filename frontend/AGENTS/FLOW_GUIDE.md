...
| **Sequential Execution** | PM gọi các Agent theo đúng thứ tự: `PM → TECH_LEAD → DEV → CODEBASE_ANALYST → DOC_SYNC` |
...
╚═══════════════════════════════════╦═════════════════════════════════╝
                                    ...
                                    ▼
╔═════════════════════════════════════════════════════════════════════╗
║                 PHASE 5: AGENT CODEBASE_ANALYST                    ║
║                                                                     ║
...
**Bước 2.4 — Gọi CODEBASE_ANALYST (sau khi DEV xong):**
```
Agent CODEBASE_ANALYST, chạy 10-phase discovery cho phạm vi TaskXXX.
```

**Bước 2.5 — Gọi DOC_SYNC (sau khi CODEBASE_ANALYST xong):**
```
...
### PHASE 5 — Agent CODEBASE_ANALYST: Brownfield Discovery

**Ai kích hoạt**: Agent PM (sau DEV done)  
**Điều kiện**: DEV đã báo done + Build pass  
**Tham chiếu**: `AGENTS/CODEBASE_ANALYST_AGENT_INSTRUCTIONS.md`
...
### PHASE 6 — Agent DOC_SYNC: Drift Detection
...
| **Gate 4** (DEV → CODEBASE_ANALYST) | Tests pass + Coverage ≥ 80% + Build pass | DEV fix thêm |
| **Gate 5** (CODEBASE_ANALYST → DOC_SYNC) | 10-phase report hoàn thành | CODEBASE_ANALYST tiếp tục |
| **Gate 6** (DOC_SYNC → PM Close) | SYNC_REPORT đã lưu | DOC_SYNC xuất report |
