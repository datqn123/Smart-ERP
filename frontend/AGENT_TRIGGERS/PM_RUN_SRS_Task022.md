...
- **Source SRS (bắt buộc)**: `docs/srs/SRS_Task022_inbound-receipt-ui-enhancement.md`
- **Task code (bắt buộc)**: `Task022`
...
- **SRS path**: `docs/srs/SRS_Task022_inbound-receipt-ui-enhancement.md`
- **Task code**: `Task022`
- **Gợi ý scope code**: `pages/InboundPage.tsx`, `mockData.ts`
- **Tasks tạo ra**: Task022 (UNIT ✅), Task023 (FEATURE ✅), Task024 (E2E ⏳)
- **DOC_SYNC report**: `docs/sync_reports/SYNC_REPORT_Task022.md`
